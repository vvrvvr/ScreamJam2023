...
namespace UHFPS.Runtime
{
    ...
    public class JumpscareManager : Singleton<JumpscareManager>
    {
        ...
        private void Awake()
        {
            ...
            jumpscareDirect = playerPresence.PlayerManager.GetComponent<JumpscareDirect>();
        ...
        private void Update()
        {
            ...
            float amplitudeGain = cinemachineBasicMultiChannelPerlin.m_AmplitudeGain;
            if (wobbleTimer > 0)
            {
            ...
            {
                cinemachineBasicMultiChannelPerlin.m_AmplitudeGain = Mathf.MoveTowards(amplitudeGain, 0f, Time.deltaTime * WobbleLossRate);
            }
        ...
        public void StartJumpscareEffect(JumpscareTrigger jumpscare)
        {
            ...
            {
                cinemachineBasicMultiChannelPerlin.m_AmplitudeGain = jumpscare.WobbleAmplitudeGain;
                cinemachineBasicMultiChannelPerlin.m_FrequencyGain = jumpscare.WobbleFrequencyGain;
            }
