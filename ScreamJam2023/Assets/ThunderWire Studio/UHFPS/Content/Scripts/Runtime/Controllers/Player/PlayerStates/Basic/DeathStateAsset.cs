...
{
    public class DeathStateAsset : StrafeStateAsset
    {
        ...
        {
            return new DeathPlayerState(machine, group, this);
        }
        ...
        public class DeathPlayerState : StrafePlayerState
        {
            ...
            public DeathPlayerState(PlayerStateMachine machine, PlayerStatesGroup group, StrafeStateAsset stateAsset) : base(machine, group) 
            {
