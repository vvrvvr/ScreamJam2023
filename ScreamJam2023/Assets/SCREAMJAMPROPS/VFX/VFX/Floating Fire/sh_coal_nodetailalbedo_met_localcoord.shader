...
Shader "BurnedURP/Coal_NoDetailAlbedo_Met_LocalCoord"
{
	Properties
	{
		...
		_CoalNoiseScale("CoalNoiseScale", Float) = 0.5
		_CoalNoiseUVPanner("CoalNoiseUVPanner", Vector) = (0.15,0,0,0)
		...
		[ASEEnd]_Roughness("Roughness", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 _WoodAlbedo_ST;
			half4 _WoodNormal_ST;
			half4 _CoalMasks_ST;
			float4 _CoalColor;
			half4 _WoodAoMet_AOR_MetG_ST;
			float2 _UVTiling;
			float2 _CoalNoiseUVPanner;
			float _StartBurning;
			float _AshesPower;
						 ...
						 ) : SV_Target
			{
				...
				half2 temp_output_45_0 = ( IN.ase_texcoord7.xy * _UVTiling );
				half4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				half4 temp_cast_0 = (CoalColor205).xxxx;
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, WorldPosition, WorldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_1 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord7.xy ) , temp_cast_1 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( IN.ase_normal.y , 0.0 ) + ( max( IN.ase_texcoord8.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				half clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				half4 lerpResult306 = lerp( ( tex2D( _WoodAlbedo, uv_WoodAlbedo ) * (1.2 + (FirePower224 - 0.0) * (0.0 - 1.2) / (1.0 - 0.0)) ) , temp_cast_0 , clampResult192);
				...
				half clampResult43 = clamp( ( 1.0 - pow( tex2D( _CoalMasks, uv_CoalMasks ).b , (0.0 + (_StartBurning - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) , 0.0 , 1.0 );
				half3 lerpResult93 = lerp( UnpackNormalScale( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) , UnpackNormalScale( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				
				half2 temp_cast_3 = (( tex2D( _CoalMasks, ( IN.ase_texcoord7.xy * 2.0 ) ).g * _CoalNoiseScale )).xx;
				half2 panner21 = ( 1.0 * _Time.y * _CoalNoiseUVPanner + temp_cast_3);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 3.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 4.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
				half temp_output_123_0 = ( 1.0 - clampResult49 );
				half4 lerpResult87 = lerp( float4( 0,0,0,0 ) , lerpResult12 , ( FirePower224 * temp_output_123_0 ));
				
				float2 uv_WoodAoMet_AOR_MetG = IN.ase_texcoord7.xy * _WoodAoMet_AOR_MetG_ST.xy + _WoodAoMet_AOR_MetG_ST.zw;
				half4 tex2DNode239 = tex2D( _WoodAoMet_AOR_MetG, uv_WoodAoMet_AOR_MetG );
				
				float CoalNoise2206 = tex2DNode24.b;
				half lerpResult238 = lerp( tex2DNode239.r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float FirePower224 = _StartBurning;
				half2 temp_output_45_0 = ( IN.ase_texcoord2.xy * _UVTiling );
				half4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				half4 temp_cast_0 = (CoalColor205).xxxx;
				...
				half2 temp_cast_1 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord2.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord2.xy ) , temp_cast_1 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( IN.ase_normal.y , 0.0 ) + ( max( IN.ase_texcoord3.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				half clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				half4 lerpResult306 = lerp( ( tex2D( _WoodAlbedo, uv_WoodAlbedo ) * (1.2 + (FirePower224 - 0.0) * (0.0 - 1.2) / (1.0 - 0.0)) ) , temp_cast_0 , clampResult192);
				
				half2 temp_cast_3 = (( tex2D( _CoalMasks, ( IN.ase_texcoord2.xy * 2.0 ) ).g * _CoalNoiseScale )).xx;
				half2 panner21 = ( 1.0 * _Time.y * _CoalNoiseUVPanner + temp_cast_3);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 3.0 * CoalColor205 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18900
68;127;1906;1221;298.7833;56.57054;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4494.289,1054.009;Float;False;Property;_TriplanarScale;TriplanarScale;15;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;305;-4531.613,842.5508;Float;True;Property;_TriplanarMap;TriplanarMap;14;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;236;-2970.067,-460.4288;Float;False;Property;_UVTiling;UVTiling;11;0;Create;True;0;0;0;False;0;False;1,1;4,4;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;174;-3824.649,1497.726;Inherit;True;Property;_TextureSample5;Texture Sample 5;0;0;Create;True;0;0;0;False;0;False;-1;None;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;29;-3149.637,1446.938;Inherit;True;Property;_TextureSample2;Texture Sample 2;0;0;Create;True;0;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;9;0;Create;True;0;0;0;False;0;False;0.18;2.38;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;8;0;Create;True;0;0;0;False;0;False;1.55;0.68;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;22;-2965.419,161.6456;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-2899.988,371.2204;Float;False;Property;_CoalNoiseScale;CoalNoiseScale;4;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-3239.084,1718.399;Float;False;Property;_StopBurning;StopBurning;13;0;Create;True;0;0;0;False;0;False;0.5;0.084;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;19;-2571.373,327.421;Float;False;Property;_CoalNoiseUVPanner;CoalNoiseUVPanner;5;0;Create;True;0;0;0;False;0;False;0.15,0;0.2,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1974.856,928.1199;Float;False;Property;_CinderPower;CinderPower;7;0;Create;True;0;0;0;False;0;False;2;0.24;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;218;-2498.403,-106.1524;Float;False;Property;_StartBurning;StartBurning;17;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;9;-1962.441,184.8739;Inherit;True;Property;_rew;rew;0;0;Create;True;0;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;33;-1909.745,-306.4492;Inherit;True;Property;_CoalMasks;CoalMasks;0;0;Create;True;0;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-1075.165,408.9827;Float;False;Property;_AshesPower;AshesPower;10;0;Create;True;0;0;0;False;0;False;3.6;3.64;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;209;-1083.838,314.1763;Inherit;False;205;CoalColor;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;100;-1869.718,381.0922;Float;False;Constant;_CoalNoisePower;CoalNoisePower;11;0;Create;True;0;0;0;False;0;False;3;2.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;316;-1341.308,395.937;Inherit;False;Constant;_Float0;Float 0;18;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;3.589062,1.183826,0.6200996,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-176.3099,-605.78;Inherit;True;Property;_WoodAlbedo;WoodAlbedo;1;0;Create;True;0;0;0;False;0;False;-1;None;d63235a1baa078547836de0f1163621a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-62.15375,384.0183;Float;False;Property;_WoodSm;WoodSm;12;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;239;148.4608,210.0624;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;319;831.2167,246.4294;Inherit;False;Property;_Roughness;Roughness;18;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-1168.178,-510.9188;Inherit;True;Property;_CoalNormal;CoalNormal;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;311;1072.725,78.11623;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;312;1072.725,78.11623;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;310;1072.725,78.11623;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;BurnedURP/Coal_NoDetailAlbedo_Met_LocalCoord;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;310;4;319;0
WireConnection;310;5;238;0
ASEEND*/
//CHKSM=BD71DA5FFD5A100C0EF1A9CEBF5E7AAFA36DEA3A